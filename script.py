...
def run_command_in_subdirs(directory, command_template):
    ...
    for entry in os.listdir(directory):
        ...
        if os.path.isdir(path):
            ...
            command = command_template.format(dir_name=dir_name)
            os.chdir(path)
...
create_db = f"codeql database create --language=java {db_dir}/{dir_name}"
...
run_command_in_subdirs(dataset_directory, create_db)
run_command_in_subdirs(dataset_directory, store_res)
